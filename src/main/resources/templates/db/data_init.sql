...
VALUES (1000, '2022-10-31', '2023-01-30', 23546, 'rmcfie0@gmail.com', 'Rodie', 'PENDING', 'McFie', 12661,
        '+996(517)755432', 3, 1, 1, true, true, false),
       (1002, '2022-11-27', '2023-05-12', 16267, 'bgowler1@gmail.com', 'Brynne', 'APPROVED', 'Gowler', 5713,
        '+996(274)454138', 2, 2, 2, true, false, false),
       (1003, '2023-04-16', '2023-05-02', 3060, 'dvarfolomeev2@gmail.com', 'Desiree', 'ACTIVE', 'Varfolomeev', 8080,
        '+996(187)667853', 3, 3, 3, false, true, false),
       (1004, '2023-06-30', '2023-08-10', 34621, 'bianeillo3@gmail.com', 'Bonnie', 'FINISHED', 'Ianiello', 12452,
        '+996(913)713953', 1, 4, 1, true, false, false),
       (1005, '2022-12-10', '2023-05-19', 49832, 'ygurnell4@gmail.com', 'Yvette', 'REJECTED', 'Gurnell', 11466,
        '+996(672)720366', 1, 5, 2, true, false, false),
       (1006, '2022-11-04', '2023-01-05', 9404, 'bsapauton5@gmail.com', 'Britteny', 'PENDING', 'Sapauton', 5820,
        '+996(582)933708', 3, 1, 3, false, false, false),
       (1007, '2022-11-08', '2023-02-28', 40802, 'aoliver6@gmail.com', 'Ava', 'PENDING', 'Oliver', 9618, '+996(657)511526',
        3, 1, 1, true, true, true),
       (1008, '2023-03-01', '2023-05-23', 33329, 'cgulleford7@gmail.com', 'Cristal', 'PENDING', 'Gulleford', 10681,
        '+996(305)559697', 1, 2, 1, false, true, false),
       (1009, '2022-11-16', '2023-07-04', 11998, 'zdoby8@gmail.com', 'Zulema', 'APPROVED', 'Doby', 12536,
        '+996(202)727702', 3, 3, 2, false, true, false),
       (1010, '2022-12-17', '2023-09-08', 17042, 'maslie9@gmail.com', 'Mair', 'ACTIVE', 'Aslie', 9323, '+996(941)804906',
        1, 1, 3, true, false, false),
       (1011, '2022-12-26', '2023-05-08', 30359, 'aboysona@gmail.com', 'Agna', 'REJECTED', 'Boyson', 6844,
        '+996(233)241710', 1, 4, 3, true, false, false),
       (1012, '2023-05-19', '2023-07-01', 39971, 'rwaterhousb@gmail.com', 'Rosette', 'HIRED', 'Waterhous', 11202,
        '+996(983)837203', 3, 5, 1, true, false, true),
       (1013, '2023-05-23', '2023-04-05', 41973, 'kcankettc@gmail.com', 'Kelsy', 'HIRED', 'Cankett', 14239,
        '+996(668)191914', 2, 1, 2, false, true, true),
       (1014, '2023-07-22', '2023-09-06', 14337, 'dpoundfordd@gmail.com', 'Doretta', 'HIRED', 'Poundford', 10349,
        '+996(383)783195', 1, 2, 3, false, true, true),
       (1015, '2023-07-23', '2022-11-24', 14655, 'zteffreye@gmail.com', 'Zabrina', 'HIRED', 'Teffrey', 12508,
