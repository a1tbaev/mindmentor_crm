...
insert into interns (id, creation_date, update_date, email, first_name, status, last_name, phone_number,
                     group_id, mentor_id, stack_id, is_paid_for_first_month, is_paid_for_second_month, is_paid_for_third_month)
VALUES (1, '2023-02-01', '2023-04-01', 'intern1@gmail.com', 'name1', 'ACTIVE',  'lastname1', '+996777888111', 1,
        1,1, false, false, false),
       (2, '2023-02-01', '2023-04-01', 'intern2@gmail.com', 'name2', 'ACTIVE', 'lastname2', '+996777888222', 2,
        2,1, false, false, false),
       (3, '2023-02-01', '2023-04-01', 'intern3@gmail.com', 'name3', 'ACTIVE', 'lastname3', '+996777888333', 3,
        2,1, false, false, false);
